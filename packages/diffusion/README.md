...
| Stable Diffusion 3 / 3.5 | Snapshot/config parsing, SD3 MMDiT transformer runtime, SD3.5 dual-attention and RMS q/k norm path, FlowMatch denoising over prepared conditioning, VAE shift/scale decode boundary | None | Gated official checkpoints still need authenticated proof | Runtime foundation; weight loading, prompt encoding, and proof remain follow-ups |
...
SD3 weight loading/prompt encoding/proof, FLUX.2 reference-image/KV variants,
