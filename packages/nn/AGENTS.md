...
The public surface holds semantic names: `gelu`, `relu`, `silu`, `swiglu`, `crossEntropy`, `mse`, `RMSNorm`, `LayerNorm`, `GroupNorm`, `RoPE`, `Linear`, `Embedding`, `Conv1d`, `ConvTranspose1d`, `Conv2d`, `Conv3d`, `Dropout`, `GroupedQueryAttention`, `LoRALinear`. Compile and shape-keyed reuse live behind these names, not in front of them.
