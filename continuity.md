...
- **Phase 10 diffusion**: `@mlxts/diffusion` now resolves Diffusers snapshot
  ...
  prepared runtime, and generated safetensor weight-loading support; prompt
  encoding and gated proof remain future work. Z-Image and
...
- **Phase 10 FLUX.2 Klein sampling foundation**: `@mlxts/diffusion` now
  recognizes current `Flux2KleinPipeline` snapshots and parses
  `Flux2Transformer2DModel` plus `AutoencoderKLFlux2` component configs as a
